...
if (process.env.NODE_ENV === 'development') {
  (window as { __store__?: typeof store; __persistor__?: typeof persistor }).__store__ = store;
  (window as { __store__?: typeof store; __persistor__?: typeof persistor }).__persistor__ = persistor;
}
