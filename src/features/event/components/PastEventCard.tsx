...
export default function PastEventCard({event}: {event: Event}) {
  ...
  return (
    <div
      ...
      className="flex m-auto gap-2 lg:gap-3 border-1 border-contrast/13 rounded-lg p-2 w-full cursor-pointer bg-background hover:scale-[102%] transition duration-300 ease-in-out"
    >
      ...
      <div className="md:block hidden w-[2px] bg-gray-300" />
