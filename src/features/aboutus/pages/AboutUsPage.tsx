                    ...
                    >
                        {(boardMembers as BoardMember[]).map((member, i) => (
                            ...
                            >
                                ...
                                />
                                <h3 className="font-semibold text-gray-800 text-center text-base md:text-lg">{member.Name}</h3>
                                <p className="text-gray-600 text-xs md:text-sm text-center">{member.Role}</p>
                            </div>
                        ))}
                    </div>
                </div>
                    ...
                    >
                        {(websiteFounders as WebsiteFounder[]).map((founder, i) => (
                            ...
                            >
                                ...
                                />
                                <h3 className="font-semibold text-gray-800 text-center mb-1 text-base md:text-lg">{founder.Name}</h3>
                                <p className="text-gray-600 text-xs md:text-sm text-center mb-3 md:mb-4">{founder.Role}</p>
                        ...
                        <div className="flex flex-col md:flex-row items-center justify-between gap-6 md:gap-8 mb-12 md:mb-16">
                            <div className="relative order-1 md:order-2">
                                ...
                                >
                                    ...
                                    />
                                    <h3 className="text-[#44697E] text-lg md:text-2xl font-bold">Vision</h3>
                                </div>
                            </div>
                        ...
                        <div className="flex flex-col md:flex-row items-center justify-between gap-8 mb-16">
                            <div className="relative order-1">
                                ...
                                >
                                    ...
                                    />
                                    <h3 className="text-[#CD3A38] text-lg md:text-2xl font-bold">Mission</h3>
                                </div>
                            </div>
                            ...
                            <div className="relative order-1 md:order-2 mx-auto md:mx-0">
                                ...
                                >
                                    <img
                                        ...
                                        className="w-9 h-9 mb-1 md:mb-3 md:w-[48px] md:h-[48px]"
                                    />
                                    <h3 className="text-[#44697E] text-lg md:text-2xl font-bold">Goals</h3>
                                </div>
                            </div>
                            <div className="flex-1 text-white order-2 md:order-1 font-bold">
                                <ul className="space-y-2 md:space-y-3 list-none">
                                    <li className="flex items-start">
                                        ...
                                        <span className="text-sm md:text-base lg:text-lg">Provide quality services and training to boost employability</span>
                                    </li>
                                    <li className="flex items-start">
                                        <span className="mr-2 md:mr-3 mt-1">•</span>
                                        <span className="text-sm md:text-base lg:text-lg">Partner with public and private entities to support initiatives</span>
                                    </li>
                                    <li className="flex items-start">
                                        <span className="mr-2 md:mr-3 mt-1">•</span>
                                        <span className="text-sm md:text-base lg:text-lg">Develop career services to improve employability</span>
                                    </li>
                                    <li className="flex items-start">
                                        <span className="mr-2 md:mr-3 mt-1">•</span>
                                        <span className="text-sm md:text-base lg:text-lg">Launch initiatives to serve TCCD stakeholders and partners</span>
                                    </li>
                                    <li className="flex items-start">
                                        <span className="mr-2 md:mr-3 mt-1">•</span>
                                        <span className="text-sm md:text-base lg:text-lg">Strengthen TCCD's network and resources</span>
                                    </li>
                                    <li className="flex items-start">
                                        <span className="mr-2 md:mr-3 mt-1">•</span>
                                        <span className="text-sm md:text-base lg:text-lg">Generate revenue for sustainability and growth</span>
                                    </li>
                                </ul>
                            </div>
                        </div>
