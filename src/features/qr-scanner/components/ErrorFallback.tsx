...
const ErrorFallback = ({ error, onReset }: ErrorFallbackProps) => {
  return (
    <div className="aspect-square w-full flex flex-col items-center justify-center bg-linear-to-br from-red-50 to-red-100 text-center p-8 rounded-xl border border-red-200">
